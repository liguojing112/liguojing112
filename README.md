...
## 👋 Hi there, I'm Guojing Li

🧠 Software Engineering + AI student

💡 Passionate about **full-stack development**, **AI applications**, and **productivity tools**

🛠️ Love building things from scratch with clean code and great UX

🌱 Currently exploring **local-first AI knowledge systems** (RAG + Ollama + Vector DB)
...
<!-- Collapsible section -->
<details>
<summary>📢 Click to hear me out~</summary>

> Hey, I'm Guojing!  
> A developer who loves building things from scratch, currently tinkering with local-first AI knowledge bases.  
> If you're also into RAG, Ollama, or productivity tools, feel free to reach out!
...
### 🔌 Clipboard Manager — [GitHub](https://github.com/liguojing112/clipboard-manager)
> A smart clipboard manager for developers, built with Vue 3 + Dexie.js.  
> **Features**: categories, fuzzy search, syntax highlight, data backup & merge, cross-device sync, dark mode.  
> **Tech**: Vue 3, IndexedDB (Dexie.js), Manifest V3, highlight.js, chrome.storage.

### 🧠 AI Personal Knowledge Base (WIP)
> A local-first AI assistant that understands your files and codebase.  
> **Planned**: RAG pipeline, vector search (ChromaDB), local LLM (Ollama), Docker deployment.  
> **Stack**: Next.js, FastAPI, LangChain, PostgreSQL, Docker.

### 🩺 Retinal Vessel Segmentation (Graduation Thesis)
> U-Net based segmentation for retinal images.  
> **Status**: Completed 8 ablation experiments.

### 🏋️ Intelligent Sit-up Counter (Collaborative)
> Real-time pose estimation for counting sit-ups and checking form.  
...
<p align="center">
  <sub>Last updated: March 28, 2026 (UTC)</sub>
</p>
